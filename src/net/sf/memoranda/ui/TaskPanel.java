...
//        subTaskB.setToolTipText(Local.getString("Add subtask111"));
...
//        subTaskB.setBorderPainted(false);
        ...
        // Action listener to listen for user selected on a task makes subTaskB visible
        ...
        upButton.setToolTipText(Local.getString("Move task up"));
        ...
        downButton.setToolTipText(Local.getString("Move task down"));
...
//			new ImageIcon(net.sf.memoranda.ui.AppFrame.class.getResource("resources/icons/todo_remove.png")));
    ...
    */
    ...
    scrollPane.getViewport().add(taskTable, null);
        ...
        tasksToolBar.add(upButton, null);
        tasksToolBar.add(downButton, null);
        ...
        taskTable.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            public void valueChanged(ListSelectionEvent e) {
                ...
                subTaskB.setEnabled(enbl);ppSubTasks.setEnabled(enbl);

				ppCompleteTask.setEnabled(enbl);
				completeTaskB.setEnabled(enbl);
                upButton.setEnabled(enbl);
                downButton.setEnabled(enbl);
	...
	taskPPMenu.add(ppShowActiveOnlyChB);
		...
		// - KEY:DELETE => delete tasks (recursively).
...
//		CurrentProject.getTaskList().adjustParentTasks(newTask);
    ...
    void subTaskButtonOn(ActionEvent e){
...
//		CurrentProject.getTaskList().adjustParentTasks(newTask);
    ...
    void moveUp_actionPerformed(ActionEvent e) {
        // TODO
    }

    void moveDown_actionPerformed(ActionEvent e) {
        // TODO
    }
